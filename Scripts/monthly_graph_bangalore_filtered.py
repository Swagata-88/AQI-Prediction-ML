...
aqi = pd.read_csv("data/bangalore_monthly_aqi_filtered.csv")

# Convert Month to datetime
aqi["Month"] = pd.to_datetime(aqi["Month"])

plt.figure(figsize=(12, 5))
plt.plot(aqi["Month"], aqi["Average_AQI"], marker="o", color="green")

plt.title("Filtered Monthly AQI Trend - Bangalore (2015–2024)")
plt.xlabel("Year")
